...
public class TerminalExamples {
	...
	public static void main(String[] args) {
		...
		Optional<Integer> maximunInt = Stream.of(1, 2, 3, 11, 7, 8, 10).max(Comparator.naturalOrder());
		System.out.println("El entero mayor es: " + maximunInt.get());

		// find the "minimum" of a stream of strings
		Optional<String> minimumString = Stream.of("banana", "apple", "apple", "orange").min(Comparator.naturalOrder());
		System.out.println("La primera cadena alfabeticamente es: " + minimumString.get());

		// find cheapest product from a stream of products
		Optional<Product> cheapestProduct = Stream
				.of(new Product("1076543", "Acme", "Vacuum Cleaner", 180.11),
